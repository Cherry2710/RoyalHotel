...
<body class="app">   	
    ...
    <div class="app-wrapper">	
            ...
            <a href="{{route('adminadd')}}" class="btn btn-primary" style="width:80px;">Add</a>
            ...
            <tbody>
                ...
                <tr>
                    <td>{{$sp->id}}</td>
                    <td><img src="{{$sp -> image}}" alt="" width="100px">
                    <td>{{$sp->hotel_id}}</td>
                    <td>{{$sp->type_id}}</td>
                    <td>${{$sp->price}}</td>
                    ...
                    <td>
                        ...
                        <form role="form" action="admin-edit-form/{{$sp->id}}" method ="get" >
                            @csrf
                        <button name="edit" class="btn btn-warning" style="width:80px;">Edit</button>
                        </form>
                        <form role="form" action="admin-delete/{{$sp->id}}" method="post">
                        @csrf
